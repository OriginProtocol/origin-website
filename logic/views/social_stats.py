...
def get_social_stats(language):
    try:
        ...
        def filter_social_stats(stat):
            general_stats = ['Discord', 'Telegram', 'Weibo', 'Wechat', 'KaKao plus friends', 'Facebook', 'Twitter', 'Instagram', 'Youtube', 'Reddit', 'Telegram (Korean)', 'Telegram (Vietnam)','Telegram (Indonesia)', 'Medium']
